...
import '../../teacher/widgets/status_chip.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                const StatusChip(status: AttendanceStatus.checkedIn),
                StatusChip(status: .atHome),
                const StatusChip(status: AttendanceStatus.checkedOut),
              ],
            ),
